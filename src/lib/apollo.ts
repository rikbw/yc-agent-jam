...
/**
 * Helper function to search organizations by name
 *
...
export async function searchOrganizationsByName(
  name: string,
  additionalParams: Omit<OrganizationSearchParams, 'q_organization_name'> = {}
): Promise<OrganizationSearchResponse> {
...
/**
 * Helper function to search organizations by location
 *
 * @param location - Location filter (city, state, country)
 * @param additionalParams - Additional search parameters
 * @returns Promise with search results
 */
export async function searchOrganizationsByLocation(
  location: { city?: string; state?: string; country?: string },
  additionalParams: Omit<OrganizationSearchParams, 'organization_locations'> = {}
): Promise<OrganizationSearchResponse> {
  return searchOrganizations({
...
/**
 * Helper function to search organizations by industry keywords
 *
 * @param keywords - Industry keywords/tags
 * @param additionalParams - Additional search parameters
 * @returns Promise with search results
 */
export async function searchOrganizationsByIndustry(
  keywords: string[],
  additionalParams: Omit<OrganizationSearchParams, 'q_organization_keyword_tags'> = {}
): Promise<OrganizationSearchResponse> {
  return searchOrganizations({
